	...
	<form action="LoginProcess" method="post">
		<center>
			<table
				...
				<tr>
					<td>Username/Email: <input type="text" name="username"
						placeholder="Please Enter UserName/Email" size="20">
					</td>
				</tr>
				...
				<tr>
					<td><input type="reset" name="cancel" value="Reset"> <input
						type="submit" name="submit" value="Login"> <a
						href="index.jsp">Registration</a>
				</tr>
			</table>
		</center>
	</form>
